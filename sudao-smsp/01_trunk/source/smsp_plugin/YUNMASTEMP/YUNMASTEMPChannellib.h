#ifndef YUNMASTEMPCHANNELLIB_H_
#define YUNMASTEMPCHANNELLIB_H_
...
namespace smsp
{
    class YUNMASTEMPChannellib:public Channellib
    {
    public:
        YUNMASTEMPChannellib();
        virtual ~YUNMASTEMPChannellib();
