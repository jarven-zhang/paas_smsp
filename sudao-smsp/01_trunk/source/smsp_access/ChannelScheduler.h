...
public:
    ...
    //void getChannel(models::Channel& smsChannel, int Operater, models::UserGw userGw, models::TemplateGw templateGw,models::TemplateTypeGw templatetypeGw);
	bool getChannel(UInt32 uChannelID, models::Channel& smsChannel);

    typedef map<int, models::Channel> ChannelMAP;
    ChannelMAP m_ChannelMap;

	/*
	ChannelMAP m_ChannelCMPP;
	ChannelMAP m_ChannelSMPP;
	ChannelMAP m_ChannelALL;
	ChannelMAP m_ChannelSGIP;
	ChannelMAP m_ChannelSMGP;
	*/
