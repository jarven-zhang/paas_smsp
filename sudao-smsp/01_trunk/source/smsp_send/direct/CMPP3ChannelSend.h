#ifndef __CMPP3CHANNELSEND_H_
#define __CMPP3CHANNELSEND_H_
...
class CMPP3ChannelSend: public IChannel, SocketHandler
{
    typedef void (CMPP3ChannelSend::*HANDLER_FUN)(pack::Reader& reader,UInt32 sequenceId, UInt32 packetLen);
public:
    CMPP3ChannelSend();
    virtual ~CMPP3ChannelSend();
public:
