#ifndef __CMPPPROVINCECHANNELSEND_H_
#define __CMPPPROVINCECHANNELSEND_H_
...
class CMPPProvinceChannelSend: public IChannel, SocketHandler
{
    typedef void (CMPPProvinceChannelSend::*HANDLER_FUN)(pack::Reader& reader,UInt32 sequenceId, UInt32 packetLen);
public:
    CMPPProvinceChannelSend();
    virtual ~CMPPProvinceChannelSend();
public:
...
private:
    ...
    bool onTransferData();
    void sendCmppLongMessage(smsDirectInfo *pSmsInfo, vector<string>& vecContent,UInt32 uTotal,UInt32 uMsgTotal, bool isIncludeChinese);
