#ifndef CMPPPROVINCESUBMITREQH
#define CMPPPROVINCESUBMITREQH
#include "CMPPBase.h"
namespace smsp
{

    class CMPPProvinceSubmitReq: public CMPPBase
    {
    public:
        CMPPProvinceSubmitReq();
        virtual ~CMPPProvinceSubmitReq();
    public:
