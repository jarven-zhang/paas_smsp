#ifndef __CMPPCHANNEL_H_
#define __CMPPCHANNEL_H_
...
class CMPPChannel: public IChannel, SocketHandler
{
    typedef void (CMPPChannel::*HANDLER_FUN)(pack::Reader& reader,UInt32 sequenceId, UInt32 packetLen);
public:
    CMPPChannel();
    virtual ~CMPPChannel();
public:
