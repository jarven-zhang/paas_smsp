#ifndef __CMPPCHANNELSEND_H_
#define __CMPPCHANNELSEND_H_
...
class CMPPChannelSend: public IChannel, SocketHandler
{
    typedef void (CMPPChannelSend::*HANDLER_FUN)(pack::Reader& reader,UInt32 sequenceId, UInt32 packetLen);
public:
    CMPPChannelSend();
    virtual ~CMPPChannelSend();
public:
