#ifndef __SMPPCHANNEL__
#define __SMPPCHANNEL__
...
class SMPPChannel: public IChannel, SocketHandler
{
    typedef void (SMPPChannel::*HANDLER_FUN)(pack::Reader& reader, SMPPBase& resp);
public:
    SMPPChannel();
    virtual ~SMPPChannel();
public:
...
private:
    ...
    void sendSmppLongMessage(smsDirectInfo *pSmsInfo, vector<string>& vecContent,UInt32 uShowSignType,UInt32 uTotal,UInt32 uMsgTotal);
