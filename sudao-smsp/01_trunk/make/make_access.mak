...
SMSP_LIB = -lhiredis -ljson -lssl -lrabbitmq -lrt -lopencc -lboost_regex-gcc-d-1_45 -lboost_date_time -lboost_thread
...
PUB_SRC = $(wildcard $(PUB_DIR)/base/*.cpp) \
		...
		$(wildcard $(PUB_DIR)/router/*.cpp)
SMSP_SRC = $(wildcard $(SMSP_DIR)/*.cpp) \
